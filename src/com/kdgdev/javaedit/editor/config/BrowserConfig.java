...
package com.kdgdev.javaedit.editor.config;

import com.kdgdev.javaedit.editor.config.classpath.*;
...
public class BrowserConfig implements ClasspathComponent {
    ...
    /**
     * Add the <tt>rt.jar</tt> archive of the JRE used by the bytecode editor to the classpath.
     */
