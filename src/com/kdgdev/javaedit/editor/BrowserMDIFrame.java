...
import com.kdgdev.javaedit.editor.codeedit.VerifierDisplay;
import com.kdgdev.javaedit.editor.config.BrowserConfig;
import com.kdgdev.javaedit.editor.config.classpath.ClasspathArchiveEntry;
import com.kdgdev.javaedit.editor.config.classpath.ClasspathBrowser;
import com.kdgdev.javaedit.editor.config.classpath.ClasspathSetupDialog;
import com.kdgdev.javaedit.editor.config.classpath.FindResult;
import com.kdgdev.javaedit.editor.config.window.WindowState;
import com.kdgdev.javaedit.editor.detail.attributes.code.CodeEditArea;
import com.kdgdev.javaedit.editor.detail.attributes.code.CodeEditPane;
...
/**
 * MDI Frame and entry point for the class file editor application.
 *
...
//	private static final ImageIcon ICON_BROWSE_CLASSPATH_LARGE = loadIcon("tree_large.png");
    ...
    private void setupActions() {
        ...
        actionShowHomepage = new DefaultAction("KJBE Homepage", ICON_WEB);
        ...
        actionShowHelp.putValue(Action.SHORT_DESCRIPTION,
                "Show the KJBE documentation");

        actionAbout = new DefaultAction("About KJBE",
                GUIHelper.ICON_EMPTY);
